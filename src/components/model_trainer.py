...
from src.entity.estimator import ProjectModel
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            logging.info("model oblect and artifact loaded")
            ...
            my_model = ProjectModel(preprocessing_object=preprocessing_obj, trained_model_object=trained_model)
